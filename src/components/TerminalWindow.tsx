...
export function TerminalWindow({ children }: TerminalWindowProps) {
  return (
    <div className="w-full max-w-5xl mx-auto">
      {/* Window Controls */}
      <div className="bg-[#2d2d2d] rounded-t-lg px-4 py-3 flex items-center gap-2">
        ...
        <div className="ml-4 text-[#8b8b8b] text-sm">
          zsh — 80×24
        </div>
      </div>
      
      {/* Terminal Body */}
      <div className="bg-[#1e1e1e] rounded-b-lg p-6 font-mono text-sm overflow-x-auto shadow-2xl border border-[#2d2d2d]">
        {children}
      </div>
    </div>
  );
